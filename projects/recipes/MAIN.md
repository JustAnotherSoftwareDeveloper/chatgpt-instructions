...
- `instructions.md` resolves the base occasion plus optional workflow/setting/service/menu modifiers and other modifier-like occasion context explicitly supported by `occasions.md`.
