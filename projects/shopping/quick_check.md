...
Escalate to `product_research.md` when the question cannot be responsibly answered within Quick Check's narrow scope or when broader market comparison is required.
...
Do not restate or weaken those authorities here.
