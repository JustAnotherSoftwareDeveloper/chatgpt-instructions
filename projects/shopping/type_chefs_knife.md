...
## 3) Market/design families
During open-market discovery, test whether the relevant market contains distinct families such as:
...
These are analytical families, not fixed taxonomy and not universal labels. A product may sit between families.

For each family actually represented, understand:
- intended cutting style/use;
- typical geometry/profile/weight tendencies;
- primary benefit;
...
Do not let a discovery pool contain many superficially different knives from one family while omitting a credible alternative philosophy.
...
## 5) Profile and cutting-motion triggers
### Heavy rocking
...
## 8) Grind / robustness override triggers
...
## 9) Reactivity / maintenance override triggers
...
## 15) Default criterion priorities
...
## 17) Knife causal reasoning
For recommendation-changing knife differences, prefer reasoning such as:
...
This should drive the visible decision-boundary section in substantial Product Research.

## 19) Research emphasis
...
## Boundary
This file owns Chef's-Knife-specific primary-tool fit, defaults, market families, and finalist research structure. Shared metallurgy/sharpening/construction/provenance rules belong to `category_kitchen_knives.md`.